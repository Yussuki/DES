...
int main()
{
    ...
    //32 - bit swap
    msg = bitSwap(msg);
    std::cout << "32-bit Swap:\t\t " << std::uppercase << std::hex << msg << '\n';

    //Permutação inversa
    msg=permutaInicialInversa(msg);
    std::cout << "Permutacao Inversa:\t " << std::uppercase << std::hex << msg << '\n';
    std::cout << "===========================" << '\n';
